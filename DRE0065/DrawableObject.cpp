...
DrawableObject::DrawableObject(Model* model, ShaderProgram* shaderProgram, int vertexCount, GLenum drawMode, bool useIndices) : model(model), shaderProgram(shaderProgram), vertexCount(vertexCount), drawMode(drawMode), transformationcom() {}
